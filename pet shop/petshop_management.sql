...
('pa05', 'husky', 2.6, 20, 5, 'white'),
('pa06', 'corgi', 10.8, 35, 3, 'brown-white'),
...
('cs01', 'Naveen', 'sunil', 'R', 'Mandya'),
('cs02', 'Lasya', 'hira', 'H V', 'Bengaluru'),
('cs03', 'Pavan', 'chikkanna', 'gowda', 'Mysuru'),
('cs04', 'Kushal', 'kumar', 'K', 'Bengaluru'),
('cs05', 'Ravi', 'shankar', 'C', 'Bengaluru'),
('cs06','Prabha','Datta','V','Kodagu');
...
('sd01', 'cs06', '2023-10-26', 9500),
('sd02', 'cs01', '2023-11-01', 3000),
('sd03', 'cs03', '2024-11-08', 500),
('sd04', 'cs04', '2024-02-2', 1250),
('sd05', 'cs02', '2024-01-17', 9350),
('sd06', 'cs05', '2024-01-20', 1900),
('sd07', 'cs07', '2024-01-08', 1000);
