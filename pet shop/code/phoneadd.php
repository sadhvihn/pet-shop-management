...
<fieldset>  
  ...
  <input type="submit" name="submit" value="ADD" style="width:100%;height:30px;
    border: 2px solid  #284b63; border-radius:5px;color:#fff; cursor:pointer;background-color: #284b63">&ensp;  
  </fieldset> 
</form> 
</body>
</html>
...
if ($conn->query($sql) == TRUE) {
  echo'<div>
  <h1 style="color:#284b63;font-size:20px; font-family: "Roboto", sans-serif;margin:auto;">New record of cs_id='
