...
border: 3px solid  #284b63;background-color: #284b63;color:#f2f2f2;font-size:15px;" formaction="customer.php">Back</button>
<button   style=" height: 50px;width: 150px;cursor:pointer;border-radius:15px;
border: 3px solid  #284b63;background-color: #284b63;color:#f2f2f2;font-size:15px;"formaction="phoneadd.php">Add new number</button>
</form>
</div>
    <?php
...
<th style='color:#eef0eb'>cs_phone</th>
</tr>";
...
border: 3px solid  #284b63;background-color: #284b63;color:#f2f2f2;font-size:15px;"type="submit" value="Delete">
