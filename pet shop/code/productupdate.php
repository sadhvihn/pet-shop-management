...
<div class="topnav">
    ...
    <form>
        ...
        border-radius:15px;
border: 3px solid #284b63;background-color:#284b63;color:#f2f2f2;font-size:17px;cursor:pointer;">back</button>
</form>
...
<fieldset> 
  ...
  <input type="submit" name="submit" value="update"  placeholder=" which pet category it belongs to" style="width:100%;height:30px;
   border: 2px solid  #284b63; color:white;border-radius:3px; cursor:pointer;background-color:#284b63">&ensp; 
</fieldset>
</form> 
</body>
</html>
...
$id = $_POST["id"];
  ...
  if($count[0]==1)
  {
    ...
    echo '<div>
    <h1 style="color:#284b63;font-size:30px; font-family: "Roboto", sans-serif;margin:auto;">Given pp_id not found</h1>
       </div>';
}
